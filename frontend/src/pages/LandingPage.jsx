    ...
    const testimonials = [
        {
            ...
            text: "Career Guide transformed my job search. My resume match rate went from 37% to 91% after optimization, and I started getting callbacks within days!"
        },
        {
            name: "Stephen H.",
            role: "Data Scientist",
            ...
            text: "The AI-powered insights helped me tailor my resume perfectly. I landed 3 interviews in 2 weeks after using Career Guide."
        },
        {
            name: "Kathleen C.",
            role: "Career Coach",
            ...
            text: "I recommend Career Guide to all my clients. The ATS optimization and gap analysis features are exactly what job seekers need in today's market."
        }
    ];
                    ...
                    <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
                        ...
                        >
                            ...
                            <p className="text-lg text-slate-600 mb-8 leading-relaxed">
                                Career Guide uses advanced AI to analyze your resume, match it with job requirements, and provide actionable insights to get you more interviews.
                            </p>
                    ...
                    <div className="grid lg:grid-cols-2 gap-12 items-center">
                        ...
                        >
                            ...
                            <p className="text-slate-600 mb-6 leading-relaxed">
                                Over 98% of Fortune 500 companies use ATS to filter resumes. Career Guide ensures your resume passes through every major system with our advanced formatting and keyword optimization technology.
                            </p>
            ...
            <div id="optimization" className="py-16 bg-white">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="grid lg:grid-cols-2 gap-12 items-center">
                        ...
                        <div>
                            <p className="text-slate-600 mb-6 leading-relaxed">
                                Career Guide identifies exactly what skills and keywords are missing from your resume compared to job requirements. Get specific, actionable suggestions to fill those gaps and become the perfect candidate.
                            </p>
                ...
                <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
                    ...
                    >
                        ...
                        <p className="text-lg text-slate-300 mb-8 max-w-2xl mx-auto leading-relaxed">
                            Join thousands of successful job seekers who landed their dream roles with Career Guide.
                        </p>
                    ...
                    <div className="grid md:grid-cols-2 lg:grid-cols-5 gap-8">
                        <div className="lg:col-span-2">
                            <div className="flex items-center gap-3 mb-4">
                                ...
                                <span className="text-xl font-bold text-white">Career Guide</span>
                            </div>
