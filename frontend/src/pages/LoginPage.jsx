                    ...
                    <div className="w-full lg:w-1/2 p-8 lg:p-12 bg-gradient-to-b from-white to-slate-50/50">
                        ...
                        >
                            <div className="flex items-center gap-2 mb-8">
                                ...
                                <span className="text-2xl font-bold bg-gradient-to-r from-slate-900 to-blue-700 bg-clip-text text-transparent">Career Guide</span>
                            </div>
                            ...
                            <div className="bg-white rounded-2xl shadow-lg border border-slate-200/80 p-8">
                                ...
                                <div className="text-center mb-8">
                                    ...
                                    <p className="text-slate-600 text-sm">
                                        Join thousands who found their dream jobs with Career Guide
                                    </p>
                                </div>
